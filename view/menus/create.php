...
<title>Crear men&uacute; &middot; Sistema de Gesti&oacute;n</title>
...
<div class="encabezadoSeccion">
    <div>
        ...
        <h2>Crear opci&oacute;n de men&uacute;</h2>
        <p class="descripcionSeccion">Agrega una opci&oacute;n principal o un submen&uacute; para el sistema.</p>
    </div>
...
if(isset($_GET["mensaje"])){
    if($_GET["mensaje"]=="ok"){
        echo '<div class="mensajeExito">Opci&oacute;n de men&uacute; creada correctamente.</div>';
...
<select name="idMenuPadre" id="idMenuPadre">
    <option value="">Opci&oacute;n principal (nivel superior)</option>
...
<div id="bloqueEsGrupo" class="campoCheckbox">
    <label>
        <input type="checkbox" name="esGrupo" id="esGrupo" value="1">
        <span>Este men&uacute; solo agrupa submen&uacute;s y no lleva a una p&aacute;gina propia.</span>
    </label>
</div>
...
<div class="accionesFormulario">
    ...
    <input type="submit" value="Guardar opci&oacute;n">
</div>
</form>
</main>
